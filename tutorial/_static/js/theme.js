...
if (downloadNote.length >= 1) {
    ...
    var githubLink = "https://github.com/pysensing/tutorials/blob/main/" + tutorialUrlArray.join("/") + ".py",
        notebookLink = $(".reference.download")[1].href,
        notebookDownloadPath = notebookLink.split('_downloads')[1],
        colabLink = "https://colab.research.google.com/github/pysensing/tutorials/blob/gh-pages/_downloads" + notebookDownloadPath;
